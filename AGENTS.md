...
5. Каждый уровень — полностью заполненный markdown по своему шаблону: фронт-маттер (title, labels, assignees) и все секции. HTML-комментарии-подсказки в результате удаляй.
